...
import org.plugination.connect.html.HtmlWebSocket.ByteArrayBuffer;
 ...
 * </ul>
 * @since Android 1.0 */
public abstract class ByteBuffer extends Buffer implements Comparable<ByteBuffer>, StringToByteBuffer, ByteArrayBuffer {

	@Override
	public java.nio.ByteBuffer wrap(ArrayBuffer arrayBuffer) {
