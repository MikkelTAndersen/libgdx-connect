...
public class DesktopRTCPeerConnection implements RTCPeerConnection {
	private DataChannel dataChannel;
	private PeerConnection pc;
	private EventListener listener;
	private PeerConnectionFactory factory = new PeerConnectionFactory();

	public DesktopRTCPeerConnection(final EventListener listener) {
...
//						}});
	...
	class CreatePeerConnectionObserver implements Observer {
		...
		public void onDataChannel(DataChannel dataChannel) {
			DesktopRTCPeerConnection.this.dataChannel = dataChannel;
